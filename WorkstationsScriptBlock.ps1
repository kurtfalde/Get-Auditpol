        Param($Workstationsmtx, $WorkstationsMetaResultsFile)
        $computer = $_
        ...
        $Workstationsmtx.WaitOne(300000)
        $Computercsv | Export-Csv $WorkstationsMetaResultsFile -Encoding ASCII -NoTypeInformation -Append
        $Workstationsmtx.ReleaseMutex()