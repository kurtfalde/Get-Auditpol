        Param($Serversmtx, $ServersMetaResultsFile)
        $computer = $_
        ...
        $Serversmtx.WaitOne(300000)
        $Computercsv | Export-Csv $ServersMetaResultsFile -Encoding ASCII -NoTypeInformation -Append
        $Serversmtx.ReleaseMutex()